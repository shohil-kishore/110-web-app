...
(function(Nextweb) {
    ...
    window.gamedata.createTypes = function(session) {
        ...
        // required data types
        t.brandName = types.append("type", "./brandName");
        t.vision = types.append("type", "./vision");
        t.brandImage = types.append("type", "./brandImage");
        t.brandVideo = types.append("type", "./brandVideo");
        t.industry = types.append("type", "./industry");

        // game 1 types
        t.correctStrategy = types.append("type", "./correctStrategy");
        t.competitiveScope = types.append("type", "./competitiveScope");
        t.costStrategy =types.append("type", "./costStrategy");

        // game 2 types
        t.correctIndustryStructure = types.append("type", "./industryStructure");
        t.threatOfSubsitutes = types.append("type", "./threatOfSubsitutes");
        t.supplierPower = types.append("type", "./supplierPower");
        t.rivarly = types.append("type", "./rivalery");
        t.buyerPower = types.append("type", "./buyerPower");
        t.newEntrants = types.append("type", "./newEntrants");

        // game 3 types
        t.correctValueChainActivites = types.append("type", "./correctValueChainActivities");
        t.valueChainJustification = types.append("type", "./valueChainJustification");

        // game 4 types
        t.processName = types.append("type", "./processName");
        t.importantProcess = types.append("type", "./importantProcess");
        t.processSteps = types.append("type", "./processSteps");

        // game 5 types
        t.systems = types.append("type", "./systems");
        t.orgUnits = types.append("type", "./orgUnits");
        // <!-- one.end -->
    ...
    priv.defineCase1Starbucks = function (t, c) {
        ...
        c.append(
            "https://res.cloudinary.com/objecthub/image/upload/v1509667740/u1mgr8fsr5ymv9kexxbl.jpg",
            "./brandImage").append(t.brandImage);
        c.append("https://www.youtube.com/watch?v=mdewPUKAhMY",
        ...
        c.append(
            "Broad Market: Starbucks markets to all customers of the cafe industry, which is broad market.",
            "./competitveScope").append(t.competitiveScope);

        c.append(
            "High Cost: Starbucks has a focus on high quality and customer service, indicative of a high cost strategy.",
        ...
        c.append(
            "High: A substitute to the cafe industry is to prepare food and drink at home, or purchase groceries from a supermarket.",
            "./threatOfSubsitutes").append(t.threatOfSubsitutes);

        c.append(
            "Low: Suppliers mainly provide commodity products, such as milk and coffee beans, where there are plenty of alternative suppliers to choose from.",
            "./supplierPower").append(t.supplierPower);

        c.append(
            "High: There are many participants in this industry. Rivalry could potentially be reduced through innovation and differentiation.",
            "./rivarly").append(t.rivarly);

        c.append(
            "High: Buyer power could be reduced through loyalty programmes, product differentiation, and switching costs.",
            "./buyerPower").append(t.buyerPower);

        c.append(
            "High: There are low start-up costs required to enter the cafe industry.",
        ...
        c.append("procurement,makeProjectOrService,technologyDevelopment", "./valueChainActivites").append(t.correctValueChainActivites);

        c.append("Procurement: Starbucks needs to get the best quality, certified fairtrade coffee beans.\n"+
                 "Make Product or Service: Starbucks' strategy involves quality, and pleasing people - this is achieved through providing the best possible cup of coffee possible. \n"+
        ...
        c.append(
            "The quality of coffee beans is very important for Starbucks. They need to select the hightest quality suppliers in order to be able to produce the best coffee.")
        ...
        c.append(
            "Quote Collection System:Quote Analysis System:Supplier Management System")
        .append(t.systems);
    ...
    priv.defineCase2Nike = function(t, c) {
        ...
        c.append(
            ...
            "./brandVision").append(t.vision);
        c.append("https://res.cloudinary.com/objecthub/image/upload/v1512011523/xpo6pu2883hgrw01owok.jpg",
                 "./brandImage").append(t.brandImage);
        c.append("https://www.youtube.com/watch?v=pkhtgbBr-cY",
                 "./brandVideo").append(t.brandVideo);
        ...
        c.append(
            "Low: In this day and age where nearly everyone who engages in physical activity 'must have' appropriate gear, there is no adequate substitute for sporting apparel footwear.",
            "./threatOfSubsitutes").append(t.threatOfSubsitutes);

        c.append(
            "Low: Most of the raw materials used in this industry are not difficult to procure, and are widely available.",
            "./supplierPower").append(t.supplierPower);

        c.append(
            "High: There is a lot of competition between the already established companies as they have to distinguish between very similar products. Brand loyalty is very high and so competitors struggle to gain market share.",
            "./rivarly").append(t.rivarly);

        c.append(
            "High: In this day and age there are many players in the industry that make what are traditionally similar products which gives buyers a lot of choice. However the players in the industry seek to reduce this by product innovation.",
            "./buyerPower").append(t.buyerPower);

        c.append(
            "High: The technology behind the apparel can be easily manufactured. However, the existing brand loyalty shown by customers will make it extremely hard for any new entrant to gain traction once in the market place.",
            "./newEntrants").append(t.newEntrants);

        // Game 3, Value chain

        // see http://slicnet.com/mxrogm/mxrogm/apps/nodejump/docs/8/n/Types/Value_Chain_Activites
        c.append("marketing,makeProjectOrService,technologyDevelopment", "./valueChainActivites").append(t.correctValueChainActivites);

        c.append("Market and Sell the Product or Service: Nike relies on its marketing to enhance its famous brand image (which is its highest selling point). Nike focuses on the importance of self-belief and true effort in order to be the best, and attempts to show how their products can take you there.\n"+ 
                 "Make Product or Service: Nike has to ensure that its products are of the highest quality to ensure that it stands up to the image that it portrays in its marketing strategy.\n"+ 
    ...
    priv.defineCase3 =  function(t, c) {
        ...
        c.append("https://res.cloudinary.com/objecthub/image/upload/v1512011706/hlrdxyrxudwak6ixplb8.png", "./brandImage").append(t.brandImage);
        ...
        c.append("High: A substitute to fine jewellery is costume jewellery, or second-hand jewellery.", "./threatOfSubsitutes").append(t.threatOfSubsitutes);
        c.append("High: DeBeers, one of the sellers of diamonds, has huge power and controls the flow of diamonds into the market. (http://www.photopla.net/wwp0503/supplier.php). They supply half the world's diamonds by value and can name their price. (http://www.slideshare.net/ebayworld/blue-nile-paper). Gold is a commodity, however the price for this is set by world markets in which Michael Hill has very little influence.", "./supplierPower").append(t.supplierPower);
        c.append("High: There are no switching costs, and as each item of jewellery is different, product differentiation does not apply. The focus is on the retailer getting the customer in the door, and keeping them from visiting the competition. This is achieved through eye-catching window displays, repeat purchase lines, and advertising.", "./rivarly").append(t.rivarly);
        c.append("High: There are a range of choices within the industry. Therefore, the industry focuses on service to compete istead of product price.", "./buyerPower").append(t.buyerPower);
        c.append("High: There are low start up costs for opening a retail fine jewellery store, other than purchase of inventory. This does not include the manufacture of jewellery, which is a different industry. ", "./newEntrants").append(t.newEntrants);
    ...
    priv.defineCase4AucklandZoo =  function(t, c) { 
        ...
        c.append("https://res.cloudinary.com/objecthub/image/upload/v1512011842/jtzkuvteiezmwdrf0gso.jpg", "./brandImage").append(t.brandImage);
        ...
        c.append("High: A substitute to visiting a zoo would be to watch a nature documentary (easier), or visit the animals in their natural habitat (harder).", "./threatOfSubsitutes").append(t.threatOfSubsitutes);
        c.append("High: Zoos are supplied with animals, which need to be appropriately bred and selected. There is often a focus on endangered animals and conservation, so finding endangered species to house is also difficult.", "./supplierPower").append(t.supplierPower);
        c.append("Low: Each zoo is very different due to a different array of animals and exhibits. Some zoos have specific well-known animals that attract visitors.", "./rivarly").append(t.rivarly);
        c.append("Low: In New Zealand there are few choices of zoos. Each zoo is very different, so consumers do not get the same experience at different venues, and even on different visits.", "./buyerPower").append(t.buyerPower);
        c.append("Low: Because the supplier power is so high, as well as the infrastructure, training and resource costs, there is little chance of a large scale competitor entering the market. Smaller, native-species zoos pose a higher threat.", "./newEntrants").append(t.newEntrants);
        ...
        c.append("Maintenance Schedule Management System:Inventory Management System:Maintenance Schedule Management System", "./systems").append(t.systems);
    ...
    priv.defineCase5Countdown = function(t, c) {
        ...
        c.append("https://res.cloudinary.com/objecthub/image/upload/v1512012000/mlw8zixmthgdh0z5r1lq.jpg", "./brandImage").append(t.brandImage);
        c.append("https://www.youtube.com/watch?v=2GDr1qiha2k", "./brandVideo").append(t.brandVideo);
        ...
        c.append("High Cost: Countdown's vision is to help people 'shop smarter' and it does that by offering a superior shopping experience.", "./costStrategy").append(t.costStrategy);

        c.append("low:low:high:high:low", "./correctIndustryStructure").append(t.correctIndustryStructure);
        c.append("Low: A substitute to a supermarket would be a greengrocer, or a convenience store, but neither of these offer the range that a supermarket does.", "./threatOfSubsitutes").append(t.threatOfSubsitutes);
        c.append("Low: Supermarkets buy in huge bulk quantities so are able to negotiate a good price with suppliers. Suppliers also often sell commodity products so supermarkets have many options to choose from.", "./supplierPower").append(t.supplierPower);
        c.append("High: The NZ industry is dominated by 4 major players.  As they mostly sell the same items, the focus becomes on advertising the latest specials and offering incentives to gain business.", "./rivarly").append(t.rivarly);
        c.append("High: Low switching costs. Companies sell the same products, so competition is based primarily on price and brand image.", "./buyerPower").append(t.buyerPower);
        c.append("Low: There are minimal startup costs to establish a small grocery store. However as the industry is dominated by 4 large companies the ability to gain market share would be doubtful.", "./newEntrants").append(t.newEntrants);
        ...
        c.append("Procurement: As competition is based on price and margins are narrow, it is essential that a supermarket can source and negotiate the best merchandise and ideal quantity, at the best price.\n"+
                 "Firm Infrastructure: Supermarkets provide convenience to consumers, and a good facility and location adds value. For Countdown this is especially true as it needs to ensure that its online cntres support online shoppers.\n"+
        ...
        c.append("Inventory Management System:Inventory Order Management System:Inventory Order Management System", "./systems").append(t.systems);
    ...
    priv.defineCase6RainbowsEnd = function(t, c) {
        ...
        c.append("https://res.cloudinary.com/objecthub/image/upload/v1512012141/m6mrzlnz9cl1rkbxhwgg.png", "./brandImage").append(t.brandImage);
        c.append("https://www.youtube.com/watch?v=-Qkj-xyVp_o", "./brandVideo").append(t.brandVideo);
        ...
        c.append("high:high:low:low:low", "./correctIndustryStructure").append(t.correctIndustryStructure);
        c.append("High: The theme park industry provides a thrilling experience. This can be substituted by the adventure tourism industry, in the form of extreme sports such as white water rafting, bungee jumping and sky-diving, which in New Zealand are in ready supply.", "./threatOfSubsitutes").append(t.threatOfSubsitutes);
        c.append("High:Rides are supplied by international manufacturing companies. As each ride is unique between manufacturers, theme parks have low purchasing power.", "./supplierPower").append(t.supplierPower);
        c.append("Low: Competitors are separated geographically, and in New Zealand there are only two.", "./rivarly").append(t.rivarly);
        c.append("Low: There are minimal parks to choose from, each offering completely different rides and attractions. Customers pay for an experience which is hard to place a definitive monetary value on.", "./buyerPower").append(t.buyerPower);
        c.append("Low: A theme park needs resource consent, a large land area, and has huge initial capital investment costs.", "./newEntrants").append(t.newEntrants);
        ...
        c.append("Accounting System:Sales Analysis System:Financial Planning System", "./systems").append(t.systems);
    ...
    priv.defineCase7Coke = function(t, c) {
        ...
        c.append("https://res.cloudinary.com/objecthub/image/upload/v1512012320/tfyt5mkndl3lee8eexuy.png", "./brandImage").append(t.brandImage);
        ...
        c.append("Customer Data Analysis System:Campaign Development System:Campaign Monitoring System", "./systems").append(t.systems);
    ...
    priv.defineCase8Pandora = function(t,c) {
        ...
        c.append("https://res.cloudinary.com/objecthub/image/upload/v1512012538/lcqmrutuchzhtisfw6pb.jpg", "./brandImage").append(t.brandImage);
        ...
        c.append("costLeadership", "./correctStrategy").append(t.correctStrategy);
        c.append("Broad Market: Pandora targets everyone who listens to music.", "./competitiveScope").append(t.competitiveScope);
        c.append("Low Cost: Pandora offers part of their services for free.", "./costStrategy").append(t.costStrategy);

        c.append("high:low:high:high:high", "./correctIndustryStructure").append(t.correctIndustryStructure);
        c.append("High: There are lots of alternatives to listening to music such as watching TV, Movies, browsing the web etc.", "./threatOfSubsitutes").append(t.threatOfSubsitutes);
        c.append("Low: The music labels have attempted to shut down Pandora and failed so I would suggest their power is low.  The Internet infrastructure suppliers have little power as there are many of them in the market.", "./supplierPower").append(t.supplierPower);
        c.append("High: There are quite a few companies in the Internet radio space and they all offer their core service for free.", "./rivalry").append(t.rivarly);
        c.append("High: Buyers can very easily switch to a rival provider.  Pandora attempts to reduce their power by using IT to make sure that customers only get music they love.", "./buyerPower").append(t.buyerPower);
        c.append("High: There are no major impediments to starting up an online radio business.", "./newEntrants").append(t.newEntrants);
        ...
        c.append("Song Database Management System:Song Analysis System:Song Database Management System", "./systems").append(t.systems);
        c.append("O1:O2:O3", "./orgUnits").append(t.orgUnits);
    ...
    priv.defineCase9Bungy = function(t,c) {
        ...
        c.append("https://res.cloudinary.com/objecthub/image/upload/v1512012611/ypbnt4lsidpju3juazt4.jpg", "./brandImage").append(t.brandImage);
        ...
        c.append("Conceptualise New Product:Assess Product Concept Feasibility:Select Best Product/Service", "./processSteps").append(t.processSteps);

        c.append("Concept Management System:Product Concept Analysis System:Product Development Management System", "./systems").append(t.systems);
        c.append("O1:O2:O3", "./orgUnits").append(t.orgUnits);
    ...
    priv.defineCase10Amazon = function(t, c) {
        ...
        c.append("https://res.cloudinary.com/objecthub/image/upload/v1512012699/bnstj7vamvfnhzei6hy8.png", "./brandImage").append(t.brandImage);
        ...
        c.append("Low: Shopping in-store is such a broad industry that all substitutes are likely to be included.", "./threatOfSubsitutes").append(t.threatOfSubsitutes);
        c.append("Low: There are a multitude of suppliers to the global online shopping industry ", "./supplierPower").append(t.supplierPower);
        c.append("High: There are a multitude of companies competing in the global online shopping industry .", "./rivarly").append(t.rivarly);
        c.append("High: Buyers have a wide variety of companies to choose from in the global online shopping industry .", "./buyerPower").append(t.buyerPower);
        c.append("High: Competitors are entering every segment of the global online shopping industry  all the time.", "./newEntrants").append(t.newEntrants);
        ...
        c.append("Procurement: Amazon needs to source all of it's products hence procurement is important.\n"+
                 "Delivery: Delivery is vital as Amazon doesn't have physical stores so actually getting the goods to the customer in one piece quickly is vital.\n"+
                 "After Sales Service: Customer Service is obviously important as being customer centric is part of their vision.", "./valueChainJustification").append(t.valueChainJustification);
        ...
        c.append("Customer Data Management System:Sales Analysis System:Recommendation System", "./systems").append(t.systems);
        c.append("O1:O2:O3", "./orgUnits").append(t.orgUnits);
    ...
    priv.defineCase11Orcon = function(t, c) {
        ...
        c.append("https://res.cloudinary.com/objecthub/image/upload/v1512012789/ltijitecljsh9lzxtzn6.png", "./brandImage").append(t.brandImage);
        c.append("http://www.youtube.com/watch?v=kxl3yAXHryY", "./brandVideo").append(t.brandVideo);
        c.append("Internet Service Provider Industry", "./industry").append(t.industry);

        c.append("costLeadership", "./correctStrategy").append(t.correctStrategy);
        c.append("Broad Scope:  Aimed at everyone in New Zealand.", "./competitiveScope").append(t.competitiveScope);
        c.append("Low Cost:  Aims to provide a low cost packages.", "./costStrategy").append(t.costStrategy);

        c.append("low:high:high:high:high", "./correctIndustryStructure").append(t.correctIndustryStructure);
        c.append("Low: There is not really a substitute for internet access.", "./threatOfSubsitutes").append(t.threatOfSubsitutes);
        c.append("High: In the NZ context there is only one international backbone provider and they have significant supplier power.", "./supplierPower").append(t.supplierPower);
        c.append("High: There is a lot of competition in the NZ ISP market.", "./rivarly").append(t.rivarly);
        c.append("High: Consumers want the best price and switching costs are low.  However, the ISPS try to mitigate this via annual contracts.", "./buyerPower").append(t.buyerPower);
        c.append("High: It is very easy to set up an ISP and a number of companies such as SKYTV who are not traditional ISPs are looking at entering into this space.", "./newEntrants").append(t.newEntrants);

        c.append("marketing,afterSales,technologyDevelopment", "./correctValueChainActivites").append(t.correctValueChainActivites);
        ...
        c.append("Receive Subscription Request:Verify Customer Details:Process Payment", "./processSteps").append(t.processSteps);

        c.append("Subscription Management System:Subscription Management System:Accounting System", "./systems").append(t.systems);
    ...
    priv.defineCase12Kiwibank = function(t, c) {
        ...
        c.append("https://res.cloudinary.com/objecthub/image/upload/v1512012867/tj0jf4du0kqbl5e6fjnr.png", "./brandImage").append(t.brandImage);
        c.append("https://www.youtube.com/watch?v=AOmC0NIGfRE&list=PL36471AF1A649489A", "./brandVideo").append(t.brandVideo);
        c.append("Banking Industry", "./industry").append(t.industry);
        ...
        c.append("low:high:high:high:high", "./correctIndustryStructure").append(t.correctIndustryStructure);
        c.append("Low: It is hard to imagine living in a modern society without a bank.", "./threatOfSubsitutes").append(t.threatOfSubsitutes);
        c.append("High: Capital is the primary resource of any bank and in a NZ context the power of the market dictates that supplier power is likely to be high.", "./supplierPower").append(t.supplierPower);
        c.append("High: Banking has been around for hundreds of years, and just about everyone who need a bank already has one. Because of this, banks must attempt to lure clients away from competitor banks. They do this by offering lower financing, higher rates, investment services, and greater conveniences than their rivals. ", "./rivarly").append(t.rivarly);
        c.append("High: Banks often have relatively high switching costs. If a person has one bank that services their banking needs, mortgage, savings, checking, etc, it can be a huge hassle for that person to switch to another bank. However, some smart banks are using technology to make this process painless thus reducing the switching costs.", "./buyerPower").append(t.buyerPower);
        c.append("High: Banking requires a great deal of trust and there are very stringent legal and financial requirements.", "./newEntrants").append(t.newEntrants);
        ...
        c.append("After Sales Service: KiwiBank prides itself on customer service.\n"+
                 "Technology Development: KiwiBank uses technology to innovate and provide customers with better value banking.\n"+
        ...
        c.append("Customer support process", "./processName").append(t.processName);
        ...
        c.append("Customer Complaint Management System:Customer Support Management System:Customer Support Management System", "./systems").append(t.systems);
        c.append("O1:O2:O3", "./orgUnits").append(t.orgUnits);
    ...
    priv.defineCase13StateInsurance = function(t, c) {
        ...
        c.append("https://res.cloudinary.com/objecthub/image/upload/v1512012951/qwruhevceqokrxnznav6.png", "./brandImage").append(t.brandImage);
        c.append("https://www.youtube.com/watch?v=ttMvXN0Qug8", "./brandVideo").append(t.brandVideo);
        ...
        c.append("Low: The only substitute to insurance is paying for the costs of the incident yourself.", "./threatOfSubsitutes").append(t.threatOfSubsitutes);
        c.append("High: Suppliers for the NZ insurance industry are the large insurance corporations overseas.", "./supplierPower").append(t.supplierPower);
        c.append("High: There are many  insurance companies in NZ: State, AA, Tower, AMI, FinTel who are in intense competition.", "./rivarly").append(t.rivarly);
        c.append("High: Buyer power is high as the buyers have many insurance companies to choose from. However, most insurance companies provide some distinct benefits and loyalty programmes in association with other organisations. For example, State insurance earns customers Flybuy points.  They are attempting to limit the buyers power through these programmes.", "./buyerPower").append(t.buyerPower);
        c.append("Low: Insurance companies tend to have high set up costs, and most companies in the NZ market have spent several years establishing themselves. For example, State has been serving customers for 100 years!", "./newEntrants").append(t.newEntrants);
        ...
        c.append("Deliver the Service: State insurance aim to excel in their ability to pay claims.\n"+
                 "After Sales Service: It is important for them to ensure that customers are happy with the whole claims process.\n"+
                 "Marketing: Marketing is important because State insurance targets a broad market, always looking to expand both their personal and business customer base.", 
                 "./valueChainJustification").append(t.valueChainJustification);
        ...
        c.append("Claims Processing System:Claims Analysis System:Claims Processing System", "./systems").append(t.systems);
    ...
    priv.defineCase14Listerine = function(t, c) {
        ...
        c.append("https://res.cloudinary.com/objecthub/image/upload/v1512013066/ugnklcs1rhpiikbwbwrq.png", "./brandImage").append(t.brandImage);
        c.append("https://www.youtube.com/watch?v=9RmAwY8OzjY", "./brandVideo").append(t.brandVideo);
        ...
        c.append("high:low:high:high:high", "./correctIndustryStructure").append(t.correctIndustryStructure);
        c.append("High: Toothpaste, gum, mouth spray are all substitutes to mouthwash.", "./threatOfSubsitutes").append(t.threatOfSubsitutes);
        c.append("Low: The chemical compounds that Listerine is made from are cheap and plentiful although they are sourced from hundreds of different places around the world.", "./supplierPower").append(t.supplierPower);
        c.append("High: There are a number of companies in the mouthwash space and they compete quite intensely.", "./rivarly").append(t.rivarly);
        c.append("High: There are a wide variety of mouthwashes and alternative dental health products available for the consumer to choose from.", "./buyerPower").append(t.buyerPower);
        c.append("High: Any of the major toothpaste brands (as well as others) could probably find it easy to create a mouthwash.", "./newEntrants").append(t.newEntrants);

        c.append("procurement,makeProjectOrService,marketing", "./correctValueChainActivites").append(t.correctValueChainActivites);
        c.append("Procurement: Procurement is important as Listerine has to source multiple ingredients from multiple sources around the world.\n"+
                 "Make the Product or Service: Making the product is also important as the product has to be made perfectly to the formula each and every time.\n"+
                 "Marketing: Marketing is important as the rivalry amongst existing competitors is intense.", "./valueChainJustification").append(t.valueChainJustification);
        ...
        c.append("Sales Analysis System:Manufacturing Management System:Bottling Management System", "./systems").append(t.systems);
        c.append("Manufacturing:Accounting:Manufacturing management", "./orgUnits").append(t.orgUnits);
    ...
    priv.defineCase15Sky= function(t, c) {
        ...
        c.append("https://res.cloudinary.com/objecthub/image/upload/v1512013218/zvex4aikd8flysyokemd.jpg", "./brandImage").append(t.brandImage);
        c.append("https://www.youtube.com/watch?v=nHrRHfAPRtI", "./brandVideo").append(t.brandVideo);
        c.append("Satellite Television Industry", "./industry").append(t.industry);
        ...
        c.append("High: PayTV has to source premium content - primarily sport and movies.  The providers of these can and do charge a premium for access.", "./supplierPower").append(t.supplierPower);
        ...
        c.append("Procurement: SkyTV needs to get access to premium shows and sports content.\n"+  
                 "Make the Product or Service: SkyTV has to package the shows that they have into coherent content streams.\n"+ 
                 "Delivery: SkyTV has to ensure that the shows screen on time especially live sports.", 
                 "./valueChainJustification").append(t.valueChainJustification);
        ...
        c.append("Show Selection System:Scheduling Processing System:Scheduling Publishing System", "./systems").append(t.systems);
        c.append("Manufacturing:Accounting:Manufacturing management", "./orgUnits").append(t.orgUnits);
    ...
    priv.defineCase16Domino= function(t, c) {
        ...
        c.append("https://res.cloudinary.com/objecthub/image/upload/v1512013483/x84hy5uv4v2xwvju6dgs.jpg", "./brandImage").append(t.brandImage);
        c.append("https://www.youtube.com/watch?v=z4xmmwiyXJQ", "./brandVideo").append(t.brandVideo);
        ...
        c.append("high:low:high:high:high", "./correctIndustryStructure").append(t.correctIndustryStructure);
        c.append("High: There are many substitutes to fast food.  Any home cooked meal or higher end restaurant meal would count.", "./threatOfSubsitutes").append(t.threatOfSubsitutes);
        c.append("Low: The ingredients for fast food are typicall easily sourced and widely available.", "./supplierPower").append(t.supplierPower);
        c.append("High: Rivalry is intense in the fast food industy as there are a huge amount of players in the market.", "./rivarly").append(t.rivarly);
        c.append("High: Buyer power is high as buyers have a huge number of choices to choose from.", "./buyerPower").append(t.buyerPower);
        c.append("High: It is very easy to enter the fast food market as little capital or specialised knowledge is required.", "./newEntrants").append(t.newEntrants);

        c.append("marketing,procurement,makeProjectOrService", "./correctValueChainActivites").append(t.correctValueChainActivites);
        c.append("Marketing: Domino's is in an intensely competitive environment so marketing it's products is vital.\n"+ 
                 "Procurement: It also has to source low cost yet high quality ingredients so procurement is very important.\n"+
                 "Make the Product or Service: Customers also expect their pizza to be perfect so making the product is important.", 
                 "./valueChainJustification").append(t.valueChainJustification);
        ...
        c.append("Quote Collection System:Quote Analysis System:Supplier Management System", "./systems").append(t.systems);
        c.append("Manufacturing:Accounting:Manufacturing management", "./orgUnits").append(t.orgUnits);
    ...
    priv.defineCase17Dell= function(t, c) {
        ...
        c.append("https://res.cloudinary.com/objecthub/image/upload/v1512013661/lhecoocqqzjhrankgcog.png", "./brandImage").append(t.brandImage);
        c.append("https://www.youtube.com/watch?v=inkjc3b4DXs", "./brandVideo").append(t.brandVideo);
        ...
        c.append("low:low:high:high:high", "./correctIndustryStructure").append(t.correctIndustryStructure);
        c.append("Low: Computing devices have become ubiquitous and there are no real substitutes available.", "./threatOfSubsitutes").append(t.threatOfSubsitutes);
        c.append("Low: Overall low as there are a wide variety of manufacturers making computer components.", "./supplierPower").append(t.supplierPower);
        c.append("High: There are many participants in this industry, all doing similar things. Rivalry can be reduced through innovation and differentiation.", "./rivarly").append(t.rivarly);
        c.append("High: Buyers have a wide variety of manufacturers that they can purchase from.", "./buyerPower").append(t.buyerPower);
        c.append("High: It is relatively easy to get into the computer retail and manufacturing business as anyone can source components and put them together for resale.", "./newEntrants").append(t.newEntrants);
        ...
        c.append("Procurement is vital as Dell needs to source components so that it can make the computing devices.\n"+
                 "Technology Development is also vital as Dell needs to come up with new devices in order to attract customers.\n"+
        ...
        c.append("Acquire Customer Order:Manufacture Computing Device:Deliver Computing Device", "./processSteps").append(t.processSteps);
    ...
    priv.defineCase18McDonalds= function(t, c) {
        ...
        c.append("https://res.cloudinary.com/objecthub/image/upload/v1512013847/n5hrcjkedkrodkmgxaek.png", "./brandImage").append(t.brandImage);
        ...
        c.append("high:low:high:high:high", "./correctIndustryStructure").append(t.correctIndustryStructure);
        c.append("High: There are many substitutes to fast food including, eating at home, eating at other restaurants etc.", "./threatOfSubsitutes").append(t.threatOfSubsitutes);
        c.append("Low: There are many suppliers of foodstuffs and it is easy for organisations to switch.", "./supplierPower").append(t.supplierPower);
        c.append("High: This is a very crowded market place and competition is intense.", "./rivarly").append(t.rivarly);
        c.append("High: Buyer power is high as there are many choices although it is limited by brand loyalty and so forth.", "./buyerPower").append(t.buyerPower);
        c.append("High: New entrants are continually entering the industry as the barriers to entry are low. ", "./newEntrants").append(t.newEntrants);

        c.append("firmInfrastructure,marketing,procurement", "./correctValueChainActivites").append(t.correctValueChainActivites);
        c.append("Firm Infrastructure: McDonald's have thousands of restaurants around the world.  It is important that systems and processes are in place to support these.\n"+  
                 "Market and Sell:  As a player in a hyper competitive industry it is important that McDonalds continually markets its products.\n"+ 
                 "Procurement:  McDonalds prides itself on the quality of its goods and these depend on obtaining quality ingredients.",
                 "./valueChainJustification").append(t.valueChainJustification);
        ...
        c.append("Receive order from customer:Receive payment from customer:Pass order to kitchen", "./processSteps").append(t.processSteps);

        c.append("Order Management System:Point of Sales System:Kitchen Management System", "./systems").append(t.systems);
    ...
    priv.defineCase192Degrees= function(t, c) {
        ...
        c.append("2Degrees Mobile", "./brandName").append(t.brandName);
        c.append("Cheaper mobile calling for everyone!", "./vision").append(t.vision);
        c.append("https://res.cloudinary.com/objecthub/image/upload/v1512077363/rwzehvu8u8sskkobf0kk.png", "./brandImage").append(t.brandImage);
        c.append("https://www.youtube.com/watch?v=1Xanuq8Hz00", "./brandVideo").append(t.brandVideo);
        ...
        c.append("low:low:high:high:low", "./correctIndustryStructure").append(t.correctIndustryStructure);
        c.append("Low: There are no real substitutes to mobile communications except for older technology that is not really used anymore.", "./threatOfSubsitutes").append(t.threatOfSubsitutes);
        c.append("Low: There are a large number of potential suppliers to the mobile communications industry and no major supplier has a monopoly so the supplier power is most likely low.", "./supplierPower").append(t.supplierPower);
        c.append("High: There are 3 major players in this industry who are fierce competitors.  Hence rivalry is high.", "./rivarly").append(t.rivarly);
        c.append("High: Buyer power is high as it is easy to switch from one player to another.  There are no huge barriers beyond customer inertia.", "./buyerPower").append(t.buyerPower);
        c.append("Low: New entrants would struggle to enter the market considering the large infrastructure footprint required.", "./newEntrants").append(t.newEntrants);

        c.append("firmInfrastructure,afterSales,marketing", "./correctValueChainActivites").append(t.correctValueChainActivites);
        c.append("Firm Infrastructure:  2Degrees spent over $250 million building their mobile infrastructure and have partnerships with over 2700 outlets selling their SIM cards.\n"+
                 "After Sale Service:  2 Degrees pride themselves on their great customer service. \n"+
                 "Market and Sell:  As a new player in the industry one of 2 Degrees greatest challenges is to get their message out into the marketplace.",
                 "./valueChainJustification").append(t.valueChainJustification);

        c.append("Answer customer query process", "./processName").append(t.processName);
        c.append("2Degrees prides itself on offering great customer service, for free! 2Degrees New Zealand-based call centre is available to support customers 24 hours a day, seven days a week, and it's free for 2Degrees customers to call.", "./importantProcess").append(t.importantProcess);
        ...
        c.append("Customer Query Management System:Call Management System:Query Response Management System", "./systems").append(t.systems);
    ...
    window.gamedata.writeCaseData = function(session, node, onSuccess) {
        ...
        node.get(function(node) {
            window.t = window.gamedata.createTypes(session);
